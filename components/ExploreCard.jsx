...
const ExploreCard = ({ id, imgUrl, title, i, active, handleClick }) => (
  <motion.div
    variants={fadeIn('right', 'spring', i * 0.5, 1.75)}
      ...
      <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        ...
        <h2 className="mt-[24px] font-semibold sm:text-[32px] text-[24px] text-white">
          {title}
            ...
            : (
              <h3 className="font-semibold sm:text-[26px] text-[18px] absolute z-0 text-white lg:bottom-20 lg:rotate-[-90deg] lg:origin-[0,0]">
                {title}
              </h3>
            )}
  </motion.div>
